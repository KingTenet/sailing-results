...
export default function RegisterOOD() {
  ...
  const processHelmResult = (event) => {
    ...
    const newRegisteration = services.createOOD(
      race,
      selectedHelm,
      appState.newHelms
    );
    ...
    <>
      <form onSubmit={(evt) => evt.preventDefault()}>
        <Flex
          ...
          alignItems="center"
        >
          <BackHeader heading="Register Race Officer" />
          <Flex
            direction={"column"}
            height="100%"
            alignItems={"center"}
          ...
          >
            ...
            <Spacer />
            {selectedHelm && (
              <GreenButton onClick={processHelmResult} autoFocus>
                Add Race Officer
              </GreenButton>
            )}
