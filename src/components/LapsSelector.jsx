import { Stack, Box, Text, PinInput, PinInputField } from "@chakra-ui/react";
    ...
    return (
        <>
            <Box
                ...
                className={"input-container input-container-6"}
            >
                {!completed && (
                ...
                <Stack direction="row" marginTop={!completed ? "10px" : "0px"}>
                    {completed && (
                        <Box
                            minWidth={!completed ? "110px" : "103px"}
                            paddingTop="5px"
                        >
                            <Text fontSize={"lg"}>{"Laps"}</Text>
                        </Box>
                    ...
                    <PinInput
                        onComplete={(value) => onComplete(parseInt(value))}
                    >
