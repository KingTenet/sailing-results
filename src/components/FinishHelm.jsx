...
export default function FinishedHelm({ registeredResult }) {
            ...
            if (
                results.find(
                    (prev) =>
                        ...
                        HelmResult.getId(registeredResult),
                ) ||
                oods.find(
                    (prev) =>
                        HelmResult.getId(prev) ===
                ...
                return {
                    ...
                    registered: [
                        ...registered.filter(
                            (prev) => prev !== registeredResult,
                        ),
                    ],
                    results: [
                        ...results,
                        services.createHelmFinish(
                            registeredResult,
                            finishedLaps,
                            undefined,
                            finishTimeSeconds,
                            isDNF ? new FinishCode("DNF") : undefined,
                        ),
                    ],
                };
            }
    ...
    return (
        ...
        >
            ...
            <Spacer />
            {(finishedLaps || isDNF) && (
                <GreenButton tabIndex="-1" onClick={finishHelm} autoFocus>
                    Add to race results
                </GreenButton>
            )}
            <RedButton
